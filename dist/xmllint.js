...
var xmllint = /** @class */ (function () {
    function xmllint() {
        this.validateXML = function (options) {
            //@ts-ignore
            var Module = {
                xml: options.xml,
            ...
            Module["preRun"] = function () { var i; for (i = 0; i < (1 || Module["xml"].length); i++) {
            ...
            (function () { var i; if ("[object Array]" !== Object.prototype.toString.call(Module["schema"])) {
            ...
            Module["return"] = "";
            Module["stdout"] = Module["stderr"] = function (code) { Module["return"] += String.fromCharCode(code); };
            var moduleOverrides = {};
            var key;
            for (key in Module) {
            ...
            function addFunctionWasm(func, sig) { if (!functionsInTableMap) {
            ...
            var wasmBinaryFile = "xmllint.raw.wasm";
            ...
            var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, trackingDelegate: {}, tracking: { openFlags: { READ: 1, WRITE: 2 } }, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, lookupPath: function (path, opts) { path = PATH_FS.resolve(FS.cwd(), path); opts = opts || {}; if (!path)
                ...
                } return stream.stream_ops.ioctl(stream, cmd, arg); }, readFile: function (path, opts) { opts = opts || {}; opts.flags = opts.flags || 0; opts.encoding = opts.encoding || "binary"; if (opts.encoding !== "utf8" && opts.encoding !== "binary") {
            ...
            function _environ_get(__environ, environ_buf) { try {
                var bufSize = 0;
                getEnvStrings().forEach(function (string, i) { var ptr = environ_buf + bufSize; HEAP32[__environ + i * 4 >> 2] = ptr; writeAsciiToMemory(string, ptr); bufSize += string.length + 1; });
                return 0;
            }
            catch (e) {
                if (typeof FS === "undefined" || !(e instanceof FS.ErrnoError))
            ...
            var asmLibraryArg = { "__assert_fail": ___assert_fail, "__sys_fcntl64": ___sys_fcntl64, "__sys_getcwd": ___sys_getcwd, "__sys_ioctl": ___sys_ioctl, "__sys_mmap2": ___sys_mmap2, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "__sys_stat64": ___sys_stat64, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "gettimeofday": _gettimeofday, "memory": wasmMemory, "setTempRet0": _setTempRet0, "time": _time };
            var asm = createWasm();
            ...
            function callMain(args) { var entryFunction = Module["_main"]; args = args || []; var argc = args.length + 1; var argv = stackAlloc((argc + 1) * 4); HEAP32[argv >> 2] = allocateUTF8OnStack(thisProgram); for (var i = 1; i < argc; i++) {
